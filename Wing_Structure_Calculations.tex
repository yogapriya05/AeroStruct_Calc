...
\large Solar UAV Wing --- AE322\,/\,AE341 Group~2, IIST\\[10pt]
Group~2, IIST}
\author{}
\date{}
...
\hline
\textbf{A4.} Lift acts at $x_{CP} = 31.3\%\,c$ & Derived from $C_L$ and $C_M$ (see \S{}4.2); corrected for off-design conditions. \\
\hline
...
\hline
Maximum thickness & $t_{\max}$ & 3.6 cm = 36 mm & 12 \% $\times$ chord (see \S{}14.3) \\
\hline
...
\hline
\textbf{Rib blanks} & Balsa wood sheet (medium density, $\sim$160 kg/m$^{3}$) & 200 mm $\times$ 200 mm $\times$ 2 mm & 2 & sheets & See \S{}14.2.2 \\
\hline
